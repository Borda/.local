...
``claude-skills/_shared/codemap-context.md``, the plugin-agnostic context contract carrying the full query
...
# Full query map: claude-skills/_shared/codemap-context.md
