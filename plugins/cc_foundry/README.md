...
| `test_heal_git_artifacts.py`       | `heal_git_artifacts.py`       | 66    | PID liveness on both platform branches (Windows simulated on every host), lock verdicts, worktree tiering, CLI exit codes                                                                                                                                                                                                                                                                                                                                                                                                                 |
