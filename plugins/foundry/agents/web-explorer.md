...
Load pytorch_tracking from `${CLAUDE_PLUGIN_ROOT:-plugins/foundry}/skills/_shared/pytorch-tracking.md` in CI-maintainer mode only (when user requests PyTorch version tracking).
