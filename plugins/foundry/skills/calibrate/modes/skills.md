...
- `/research:plan`: `python "${CLAUDE_PLUGIN_ROOT:-plugins/foundry}/bin/get_plugin_install_path.py" borda-ai-rig research 2>/dev/null` → append `/skills/plan/SKILL.md`; fallback: `$(ls -td ~/.claude/plugins/cache/borda-ai-rig/research/*/skills/plan/SKILL.md 2>/dev/null | head -1 || echo "plugins/research/skills/plan/SKILL.md")`
- `/research:judge`: same helper → append `/skills/judge/SKILL.md`; fallback: `$(ls -td ~/.claude/plugins/cache/borda-ai-rig/research/*/skills/judge/SKILL.md 2>/dev/null | head -1 || echo "plugins/research/skills/judge/SKILL.md")`
