...
MANIFEST: list[dict[str, object]] = [
    {
        "canonical": "plugins/foundry/hooks/agent-router.js",
        "copies": [
            "plugins/oss/hooks/agent-router.js",
            "plugins/develop/hooks/agent-router.js",
            "plugins/research/hooks/agent-router.js",
        ],
    },
]
...
def main(argv: list[str] | None = None) -> int:
    ...
    if findings:
        ...
        print("  fix: run `python plugins/foundry/bin/propagate_shared.py --apply`")
        return 1
