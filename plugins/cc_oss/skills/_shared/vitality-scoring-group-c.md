...
Four sub-signals, each scored 0–10; overall axis score = mean of available sub-signals. Requires: merged PRs last 90d (Group 1 new fetch), last 50 commits (Group 1 new fetch), open issues (reused from Axis 4), contributor stats weeks[] (reused from Axis 3).
