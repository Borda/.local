...
Gate:        [PASS | BLOCK | REJECT_<GROUND> @<sha> — GROUND one of GOAL/CONDUCT/SCOPE/LICENSE/DUPLICATE/REVERTED/SPAM/PHILOSOPHY, see review SKILL.md Stage 1; PASS/BLOCK reach a full review, REJECT_* carries the reviewed commit SHA so /oss:resolve can detect whether the PR has since changed]
